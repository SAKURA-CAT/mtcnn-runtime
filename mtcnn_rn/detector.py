...
def detect_faces(image, min_face_size=20.0, thresholds=None, nms_thresholds=None):
    ...
    pnet = onnxruntime.InferenceSession(f"{basedir}/weights/pnet.onnx", providers=["CPUExecutionProvider"])  # Load a ONNX model
    ...
    rnet = onnxruntime.InferenceSession(f"{basedir}/weights/rnet.onnx", providers=["CPUExecutionProvider"])  # Load a ONNX model
    ...
    onet = onnxruntime.InferenceSession(f"{basedir}/weights/onet.onnx", providers=["CPUExecutionProvider"])  # Load a ONNX model
